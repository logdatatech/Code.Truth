...
https://raw.githubusercontent.com/spences10/VBA-Coding-Standards/master/README.md
...
[Force] Use explicit data casting function `Cstr()`, `CDate()`, `Cbool()` etc.
...
bounds ofthe arrayADObe declared explicitly (unless they’re not known at
design-time).
...
Each wordADObe capitalised and the words separated with an
